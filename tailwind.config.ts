...
const config = {
  ...
  safelist: [
    'bg-amber-500', 'bg-orange-500', 'bg-red-500', 'bg-rose-600',
    'bg-blue-500', 'bg-indigo-500', 'bg-green-500', 'bg-gray-400',
    'text-amber-500', 'text-orange-500', 'text-red-500', 'text-blue-500', 'text-green-600',
  ...
  theme: {
    extend: {
      colors: {
        // Radiant Scholar Theme Colors
        "background": "#feffd5",
        "secondary-container": "#8dfc75",
        "on-error": "#ffffff",
        "surface-bright": "#feffd5",
        "surface-main": "#feffd5",
        "on-secondary-fixed-variant": "#056b00",
        "outline": "#82817a",
        "tertiary-fixed-dim": "#939aff",
        "on-secondary-container": "#046000",
        "inverse-surface": "#0e0e0a",
        "primary-dim": "#864900",
        "secondary-fixed": "#8dfc75",
        "on-primary-fixed": "#291200",
        "primary": "#985300",
        "outline-variant": "#bbb9b2",
        "on-secondary-fixed": "#024b00",
        "surface-container-low": "#fcf9f0",
        "on-tertiary-fixed": "#000063",
        "secondary": "#067500",
        "error-dim": "#b92902",
        "surface-container": "#f7f3ea",
        "secondary-fixed-dim": "#80ed69",
        "on-error-container": "#520c00",
        "error-container": "#f95630",
        "tertiary-container": "#a4a9ff",
        "primary-fixed": "#fe9832",
        "tertiary-fixed": "#a4a9ff",
        "on-primary": "#ffffff",
        "error": "#be2d06",
        "surface-variant": "#ebe8de",
        "secondary-dim": "#046700",
        "primary-fixed-dim": "#ed8b24",
        "on-secondary": "#ffffff",
        ...
        "on-primary-fixed-variant": "#592e00",
        "tertiary-dim": "#454cb5",
        "tertiary": "#5259c2",
        "on-tertiary-fixed-variant": "#232995",
        "inverse-primary": "#fe9832",
        "primary-container": "#fe9832",
      ...
      fontFamily: {
        ...
        bodyText: ['Be Vietnam Pro', 'sans-serif'],
