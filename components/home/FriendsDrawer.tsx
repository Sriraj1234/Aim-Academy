                                        ...
                                        friends.map((friend, idx) => (
                                            ...
                                            >
                                                <div className="relative">
                                                    ...
                                                    <div className={`absolute -bottom-1 -right-1 w-4 h-4 border-2 border-white rounded-full flex items-center justify-center ${onlineUsers[friend.uid] ? 'bg-green-500' : 'bg-gray-400'}`}>
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className={`text-xs font-semibold ${onlineUsers[friend.uid] ? 'text-green-600' : 'text-gray-400'}`}>
                                                        {onlineUsers[friend.uid] ? 'Online Now' : 'Offline'}
                                                    </p>
                                                </div>
